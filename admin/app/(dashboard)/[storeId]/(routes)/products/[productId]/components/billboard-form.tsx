...
const formSchema = z.object({
    ...
    colorId: z.string().uuid().min(1),
    sizeId: z.string().uuid().min(1),
...
export const ProductForm: React.FC<ProductFormProps> = ({
  ...
  const description = `${initialData ? "Edit a" : "Add a new"} product`
  const toastMessage = `Product ${initialData ? "updated." : "created."}`
